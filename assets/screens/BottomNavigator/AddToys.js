...
const AddToys = () => {
  ...
  const [categoryID] = useState(73); // Default category ID (1-2 years)
  const [selectedSubCategory, setSelectedSubCategory] = useState(73); // Default to "1-2 years"
